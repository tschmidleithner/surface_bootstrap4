defmodule SurfaceBootstrap4.ButtonTest do
  ...
  test_with_params "property color", &assert_component/2 do
    [
      primary: {
  ...
  test_with_params "property block", &assert_component/2 do
    [
      block_primary: {
  ...
  test_with_params "property active", &assert_component/2 do
    [
      active: {
  ...
  test_with_params "property disabled", &assert_component/2 do
    [
      disabled: {
